...
QT_MOC_LITERAL(4, 14, 4) // "Recv"

    },
    "User\0Send\0\0id\0Recv"
};
...
void User::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Send((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 1: _t->Recv((*reinterpret_cast< const int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (User::*)(const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&User::Send)) {
                *result = 0;
                return;
            }
        }
